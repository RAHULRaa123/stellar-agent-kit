...
const tabContentClass =
  "protocol-tab-content w-full relative z-10 data-[state=inactive]:z-0 data-[state=inactive]:pointer-events-none data-[state=inactive]:absolute data-[state=inactive]:inset-0 data-[state=inactive]:opacity-0 data-[state=active]:opacity-100 outline-none transition-opacity duration-300"

export function ProtocolInterfacesSection() {
  const [activeTab, setActiveTab] = useState<ProtocolId>("soroswap")

  return (
    <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as ProtocolId)} className="w-full">
      ...
      <div className="relative min-h-[600px] w-full">
        <TabsContent value="soroswap" forceMount className={tabContentClass}>
        ...
        <TabsContent value="blend" forceMount className={tabContentClass}>
          <div className="rounded-2xl border border-zinc-800 bg-zinc-950/50 p-6">
            <div className="flex items-center gap-3 mb-6">
        ...
        <TabsContent value="allbridge" forceMount className={tabContentClass}>
          <div className="rounded-2xl border border-zinc-800 bg-zinc-950/50 p-6">
            <div className="flex items-center gap-3 mb-6">
        ...
        <TabsContent value="fxdao" forceMount className={tabContentClass}>
          <div className="rounded-2xl border border-zinc-800 bg-zinc-950/50 p-6">
            <div className="flex items-center gap-3 mb-6">
        ...
        <TabsContent value="reflector" forceMount className={tabContentClass}>
          <div className="rounded-2xl border border-zinc-800 bg-zinc-950/50 p-6">
            <div className="flex items-center gap-3 mb-6">
